...
namespace XafGraphana.Blazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddXaf(Configuration, builder =>
            {
                ...
                builder.Modules
                    ...
                    .AddViewVariants()
                    .Add<XafGraphana.Module.XafGraphanaModule>()
                    .Add<XafGraphanaBlazorModule>();
                builder.ObjectSpaceProviders
                    .AddSecuredEFCore(options =>
                    {
                        options.PreFetchReferenceProperties();
                    })
                    .WithDbContext<XafGraphana.Module.BusinessObjects.XafGraphanaEFCoreDbContext>((serviceProvider, options) =>
                    {
                ...
                builder.Security
                    .UseIntegratedMode(options =>
                    {
                        ...
                        options.UserType = typeof(XafGraphana.Module.BusinessObjects.ApplicationUser);
                        // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                        // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                        options.UserLoginInfoType = typeof(XafGraphana.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "XafGraphana API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the XafGraphana.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "XafGraphana WebApi v1");
                });
            }
            else
            {
