...
namespace XafGraphana.Module
{
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed class XafGraphanaModule : ModuleBase
    {
        public XafGraphanaModule()
        {
            //
            // XafGraphanaModule
            //
            AdditionalExportedTypes.Add(typeof(XafGraphana.Module.BusinessObjects.ApplicationUser));
