...
namespace XafGrafana.Module
{
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed class XafGrafanaModule : ModuleBase
    {
        public XafGrafanaModule()
        {
            //
            // XafGrafanaModule
            //
            AdditionalExportedTypes.Add(typeof(XafGrafana.Module.BusinessObjects.ApplicationUser));
