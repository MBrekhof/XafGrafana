...
namespace XafGrafana.Blazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            XafGrafana.Module.BusinessObjects.XafGrafanaEFCoreDbContext.ExternalInterceptors.Add(new EfCoreMetricsInterceptor());

            services.AddXaf(Configuration, builder =>
            {
                builder.UseApplication<XafGrafanaBlazorApplication>();
                ...
                builder.Modules
                    ...
                    .AddViewVariants()
                    .Add<XafGrafana.Module.XafGrafanaModule>()
                    .Add<XafGrafanaBlazorModule>();
                builder.ObjectSpaceProviders
                    .AddSecuredEFCore(options =>
                    {
                        options.PreFetchReferenceProperties();
                    })
                    .WithDbContext<XafGrafana.Module.BusinessObjects.XafGrafanaEFCoreDbContext>((serviceProvider, options) =>
                    {
                ...
                builder.Security
                    .UseIntegratedMode(options =>
                    {
                        ...
                        options.UserType = typeof(XafGrafana.Module.BusinessObjects.ApplicationUser);
                        // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                        // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                        options.UserLoginInfoType = typeof(XafGrafana.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "XafGrafana API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the XafGrafana.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "XafGrafana WebApi v1");
                });
            }
            else
            {
